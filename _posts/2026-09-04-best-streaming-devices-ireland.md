...
- **App availability** — does it support RTÉ Player, Netflix, and your sports package?
- **Remote and interface** — how easy is daily use
- **Price and where to buy** — official Irish retailers only
...
- **Apple TV 4K** — best for existing Apple households. [Check price]({{ "https://amzn.to/4ytQGs2" }}) <!-- TODO: replace with affiliate link -->
